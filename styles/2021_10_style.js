...
var style_2021_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // Si cluster d'une seule feature
        ...
        var color = 'rgba(255, 74, 71, 1)'; // Rouge plein à 100% opacité
        var haloColor = 'rgba(255, 74, 71, 0.3)'; // Halo plus transparent
