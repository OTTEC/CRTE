...
var style_2022_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // Si cluster d'une seule feature
        ...
        var color = 'rgba(71, 163, 255, 0.8)'; // Bleu plein à 100% opacité
        var haloColor = 'rgba(71, 163, 255, 0.3)'; // Halo plus transparent
