...
var style_2024_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // Si cluster d'une seule feature
        ...
        var color = 'rgba(25, 254, 0, 1)'; // Vert plein à 100% opacité
        var haloColor = 'rgba(25, 254, 0, 0.3)'; // Halo plus transparent
